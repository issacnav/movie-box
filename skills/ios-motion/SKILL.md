...
- **Only** the main scrollable/center column — not the mini movie row or primary CTA unless spec says so.
...
4. Tuning: snappier overall → lower **`x.duration`**; more time in the “slow settle” tail → slightly **higher** `x.duration` or ease closer to **`[0.08, 0.82, 0.12, 1]`** (custom ease-out).
